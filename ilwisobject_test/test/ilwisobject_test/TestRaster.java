...
public class TestRaster {
	...
	public void rasterCalculation() {
		...
		//RasterCoverage rc = new RasterCoverage(workingDir+"raster/n000302.mpr"); //errors, invalid input
		//RasterCoverage rctif = new RasterCoverage(workingDir+"raster/n0.mpr");
		assertTrue("couldn't load RasterCoverages", rc.isValid() );
	}


	/*@Test
	public void reprojectRaster() {
		RasterCoverage rc = new RasterCoverage("n000302__1.mpr"); //errors
	...
	public void rasterSelectionWKT() {
		...
		Pixel pix1 = new Pixel(740, 650, 0); Pixel pix2 = new Pixel(300, 400, 0);
