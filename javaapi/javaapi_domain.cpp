...
/*std::string Domain::contains(QVariant* value) const{
    std::unique_ptr<QVariant> var(value);
...
std::string Domain::contains(double value) const{
    Domain::Containement dc = (Domain::Containement)this->ptr()->as<Ilwis::Domain>()->contains(QVariant(value));
    switch(dc){
    case 1: return "cSELF";
                break;
    case 2: return "cPARENT";
...
Domain *Domain::toDomain(IObject *obj){
...
NumericDomain *NumericDomain::toNumericDomain(IObject *obj){
