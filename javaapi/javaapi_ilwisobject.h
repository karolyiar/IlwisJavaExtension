#ifndef JAVAAPI_ILWISOBJECT_H
#define JAVAAPI_ILWISOBJECT_H
...
namespace javaapi {
    ...
    public:
        ...
        void open( const std::string& url,  const std::string& format  = "",  const std::string& fnamespace = "", const javaapi::IOOptions& options = javaapi::IOOptions());
        void store( const std::string& url,  const std::string& format  = "",  const std::string& fnamespace = "", const javaapi::IOOptions& options = javaapi::IOOptions());
        bool __bool__() const;
        std::string __str__();
